...
{}"""
    ...
    def translate_batch(self, batch_data, folio):
            """Processes a batch of data by generating FOL translations and optionally running inference."""
            batch_prompt_inputs = [
            ...
            for idx, prompt in enumerate(batch_prompt_inputs):
                ...
                # Save the output in a dictionary with or without prover information
                output_dict = {
...
if __name__ == '__main__':
    dataset = 'folio'
    split = 'train'
    output = 'provatrans_folio_out.json'
    batch_size = 1
